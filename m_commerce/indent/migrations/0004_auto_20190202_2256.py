# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-02-02 14:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('commodity', '0005_goodsclass_order'),
        ('indent', '0003_auto_20190129_1647'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_totalPrice', models.DecimalField(decimal_places=2, default=0, max_digits=9, verbose_name='商品总金额')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='indent.Order', verbose_name='订单ID')),
            ],
            options={
                'verbose_name': '订单商品管理',
        ...
        migrations.AddField(
            model_name='order',
            name='payment',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='indent.Payment', verbose_name='支付方式'),
        ),
        migrations.AddField(
            model_name='order',
            name='uer',
