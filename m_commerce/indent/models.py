...
class UserAddress(BaseModel):
    user = models.ForeignKey(to="users.Users",verbose_name="创建人")
    ...
    hproper = models.CharField(max_length=100,verbose_name="市",default='')
    harea = models.CharField(max_length=100,verbose_name="区",default='')
...
class Order(BaseModel):
    ...
    uer = models.ForeignKey(to="users.Users",verbose_name="用户")
    order_sn = models.CharField(max_length=64,verbose_name="订单编号")
    goods_totalPrice = models.DecimalField(max_digits=9,decimal_places=2,default=0,verbose_name="商品总金额")
...
class Payment(BaseModel):
    ...
    is_tuijian = models.BooleanField(default=False,verbose_name="是否默认推荐")
    def __str__(self):
        return self.name
